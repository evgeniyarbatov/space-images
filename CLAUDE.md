...
- Shared helpers live in `scripts/common.py`. Entry points: `inspire.py` → `album/daily/`; `nasa.py` → `images/`; `planets.py` → `images/<planet>/`.
...
- Downloaded and generated content under `images/`, `album/daily` stays gitignored.
